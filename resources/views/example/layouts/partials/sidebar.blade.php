...
<aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
  <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-black dark:border-gray-800">
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-black dark:divide-gray-700">
        <ul class="pb-2 space-y-2">
          <li>
            <form action="#" method="GET" class="lg:hidden">
              ...
              <div class="relative">
                ...
                <input type="text" name="email" id="mobile-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-black dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search">
              </div>
            </form>
          </li>
          <li>
            ...
            <ul id="dropdown-layouts" class="py-2 space-y-2 {{ Request::is('layouts/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ url('example/layouts/stacked') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('example/layouts/stacked') ? 'bg-gray-200 dark:bg-black' : '' }}">
                  Stacked
                </a>
              </li>
              <li>
                <a href="{{ url('example/layouts/sidebar') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('example/layouts/sidebar/*') ? 'bg-gray-200 dark:bg-black' : '' }}">
                  Sidebar
                </a>
              </li>
            </ul>
            ...
            <ul id="dropdown-crud" class="space-y-2 py-2 {{ Request::is('crud/*') ? 'block' : 'hidden' }}">
              <li>
                <a href="{{ url('example/crud/products') }}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700
                  {{ Request::is('crud/products') ? 'bg-gray-200 dark:bg-black' : '' }}">
                  Products
                </a>
              </li>
              <li>
                ...
                {{ Request::is('example/crud/users') ? 'bg-gray-200 dark:bg-black' : '' }}">
                Users
              </a>
              </li>
            </ul>
          ...
          <li>
            <a href="{{ url('example/settings') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ $page_slug == 'settings' ? 'bg-gray-100 dark:bg-black' : '' }}">
          ...
          <li>
            ...
            <ul id="dropdown-playground" class="space-y-2 py-2 {{ Request::is('playground/*') ? 'block' : 'hidden' }}">
              ...
              <li>
                ...
                {{ Request::is('example/playground/sidebar') ? 'bg-gray-200 dark:bg-black' : '' }}">
                    Sidebar
                </a>
            </li>
          </ul>
    ...
    <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-black" sidebar-bottom-menu>
      ...
      <div id="tooltip-settings" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-black">
        Settings page
      ...
      <!-- Dropdown -->
      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-black" id="language-dropdown">
...
<div class="fixed inset-0 z-10 hidden bg-gray-900/50 dark:bg-blue-950/90" id="sidebarBackdrop"></div>
